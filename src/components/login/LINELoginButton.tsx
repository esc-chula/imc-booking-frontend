...
const LINELoginButton = ({ onClick, isLoading }: LINELoginProps) => {
  return (
    <button
      type='button'
      ...
      <>
        ...
        {isLoading ? (
          <div role='status' className='grid flex-1 place-items-center'>
            <svg
              aria-hidden='true'
              className='text-gray-200 dark:text-gray-600 mr-2 h-8 w-8 animate-spin fill-white text-[rgb(6,199,85)]'
              viewBox='0 0 100 101'
              fill='none'
          ...
          <span
            className={`after:text-red-500 flex-1 py-3 text-lg font-semibold after:content-none min-[320px]:after:content-['_with_LINE']`}
          >
            Log in
          </span>
        )}
